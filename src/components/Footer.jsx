    ...
    <div className=' flex gap-5 w-full h-screen bg-zinc-900 p-20 font-["Founders_Grotesk_X-condensed"]'>
      ...
      <div className="w-1/2">
        ...
        <div className="dets font-['Neue_Montreal'] mt-10">
            <a className="block text-xl font-light" target='_blank' href="https://github.com/sachinaggarwal18">Github</a>
            <a className="block text-xl font-light" target='_blank' href="https://www.linkedin.com/in/sachin-aggarwal-32b162227/">Linkedin</a>
            <a className="block text-xl font-light" target='_blank' href="https://www.instagram.com/sach_18_in/">Instagram</a>
        </div>
      </div>
    </div>
  )
